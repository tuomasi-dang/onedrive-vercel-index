...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Tomasi@toyang.onmicrosoft.com',
  ...
  protectedRoutes: ['/U_disk/Completed', '/U_disk/file','/U_disk/install_page','/U_disk/Linux','/U_disk/oneself'],
